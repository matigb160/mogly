 ...
 *
 *  De la Fundación de Procesamiento y colaboradores
 *  https://github.com/processing/p5.js-sound/graphs/contributors
 *
 *  Licencia MIT (MIT)
 *  https://github.com/processing/p5.js-sound/blob/master/LICENSE
 *
 *  Algunas de las bibliotecas de audio y recursos que inspiraron p5.sound:
 *   - TONE.js (c) Yotam Mann. Licensed under The MIT License (MIT). https://github.com/TONEnoTONE/Tone.js
 *   - buzz.js (c) Jay Salvat. Licensed under The MIT License (MIT). http://buzz.jaysalvat.com/
 *   - Boris Smus Web Audio API book, 2013. Bajo la licencia de http://www.apache.org/licenses/LICENSE-2.0
 *   - wavesurfer.js https://github.com/katspaugh/wavesurfer.js
 *   - Componentes de audio por Jordan Santell https://github.com/web-audio-components
 *   - Biblioteca de sonido de Wilm Thoben's para procesar:  https://github.com/processing/processing/tree/master/java/libraries/sound
 *
 *   Audio Web API: http://w3.org/TR/webaudio/
 */
